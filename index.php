        ...
        <div class="row"><!--row-->
          ...
          <div class="column">
            <div class="columnContainer zoom" onclick="location.href='about.php';">
              ...
              <img src="/img/cad.png" alt="screenshot of a geneva drive in a CAD software" width="225" height="225"> <!--Add pic of us-->
            ...
            <div class="columnContainer zoom" onclick="location.href='about.php';">
              ...
              <img src="/img/eliPic.jpg" width="225" height="225"> <!--Add pic of us-->
          ...
          <div class="column">
            <div class="columnContainer zoom">
              ...
              <img src="/img/photography.jpg" alt="silhouette of two girls with a small dog on the beach with the sunset in the background" width="225" height="225">
              <p>stuff</p>
            </div>
          </div>
          ...
          <div class="column">
            <div class="columnContainer zoom">
              ...
              <img src="/img/arduinoDesktopProject.jpg" alt="seven segment display with wires connecting to it, displaying a menu" width="225" height="225">
            </div>
          </div>
          ...
          <div class="column">
            <div class="columnContainer zoom">
              ...
              <img src="/img/programing.png" alt="screenshot of some code" width="225" height="225">
